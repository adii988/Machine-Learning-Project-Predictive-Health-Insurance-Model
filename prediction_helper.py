...
model_young = joblib.load("artifacts1\young_model.joblib")
model_rest = joblib.load("artifacts1\\rest_model.joblib")
scaler_young = joblib.load("artifacts1\scaler_young.joblib")
scaler_rest = joblib.load("artifacts1\scaler_rest.joblib")
...
def handle_scaling(age, df):
    ...
    scale_columns = scaler_object['scale_columns']
